...
from bucketlist.controllers.controller import add_user, users, delete_user, update_user, search, authenticate
...
def initialize_api_routes(app):
    if app:
        ...
        app.add_url_rule('/auth/authenticate/', 'authenticate', authenticate, methods=['GET'])
        ...
        app.add_url_rule('/api/v1/bucketlists/<string:bucket_id>/items', 'create_bucketlist_item', create_item,
                         methods=['POST'])
        app.add_url_rule('/api/v1/bucketlists/items/<string:bucket_id>', 'item', item,
                         methods=['GET'])
        app.add_url_rule('/api/v1/bucketlists/<string:bucket_id>/items/<string:item_id>', 'item', item,
                         methods=['GET'])
        app.add_url_rule('/api/v1/bucketlists/update-item/<string:item_id>',

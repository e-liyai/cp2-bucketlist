...
def initialize_api_routes(app):
    if app:
        ...
        app.add_url_rule('/bucketlists/<string:bucket_id>', 'bucketlist_by_id', bucketlist, methods=['GET'])
        app.add_url_rule('/bucketlists/<string:bucket_id>', 'update_bucketlist', update_bucketlist, methods=['PUT'])
        app.add_url_rule('/bucketlists/<string:bucket_id>', 'delete_bucketlist', delete_bucketlist, methods=['DELETE'])
